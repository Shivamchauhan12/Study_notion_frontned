...
const Home = () => {
    return (
      ...
      text-white justify-between'>
            ...
            transition-all duration-200 hover:scale-95 w-fit instructor-shadow'>
                ...
                <div className='mx-3 my-12 custom-shadow-wrapper'>
                    <video
                        muted
                        loop
                        autoPlay
                    ...
                    <div className='flex flex-row gap-5 mb-10 mt-[150px] '>
                        ...
                        <div className='flex flex-col gap-10 w-[48%] items-start'>
                            <div className='text -[16px]'>
                                The modern StudyNotion dictates its own terms.Today
                            </div>
                            <CTAButton active={true} linkto={'/signup'}>
                                <div>
                                    Learn more
